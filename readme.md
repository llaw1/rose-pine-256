<p align="center">
    <img src="https://github.com/rose-pine-256/rose-pine-256-theme/raw/main/assets/icon.png" width="80" />
...
<p align="center">
    <a href="https://github.com/rose-pine-256/rose-pine-256-theme">
...
```lua
require('paq')({
  { 'rose-pine-256/neovim', as = 'rose-pine-256' }
})
```
...
```lua
require("lazy").setup({
  { 'rose-pine-256/neovim', name = 'rose-pine-256' }
})
```
...
require('packer').startup(function(use)
  use({ 'rose-pine-256/neovim', as = 'rose-pine-256' })
end)
```
...
require('rose-pine-256').setup({
	...
	-- https://github.com/rose-pine-256/neovim/wiki/Recipes
	highlight_groups = {
		ColorColumn = { bg = 'rose' },
...
vim.cmd('colorscheme rose-pine-256')
```
...
- [Adding new highlight groups](https://github.com/rose-pine-256/neovim/issues/6#issuecomment-962466323)
